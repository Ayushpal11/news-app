...
const Footer = (props:newsProp) => {
  return (
    <div className='bg-black h-5/6 p-4'>
        ...
        rounded-sm  block w-full h-10 p-2.5 " placeholder="Search  News app..." required/>
        <hr className='mt-3'/>
        ...
        <hr className='mt-3'/>
      <h1 className='text-white text-center mt-3'>© 2023 News Network.All Rights Reserved.</h1>
      <h1 className='text-white text-center mt-3'>Made with ❤️ by Ayush.</h1>
    </div>
  )
}
